...
public class Values {
	...
	public static void initValue() {
		...
		for (int i = 0; i < walls; i++) {
			...
			int height = Integer.valueOf(strWall[4]) - Integer.valueOf(strWall[1]);
			games.add(new Game(area, play, wall, holes, wallsFile.getString(i+".type"), wallsFile.getInt(i+".time"), wallsFile.getInt(i+".memory"), height));
		}
	}

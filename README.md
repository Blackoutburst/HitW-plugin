...
## DISCLAIMER
I do not own any permission over the real Hole in the Wall game created by Hypixel, this plugins is only made for the Hole in the Wall community on Hypixel.
This plugin do not re create the game Hole in the Wall the way it work on Hypixel.
This plugin is desogner as a core plugin for our Hole in the Wall community server so by itself you will probably be unable to do anything with the rest of the server files
